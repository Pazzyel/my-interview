...
class DocumentParseService:
    async def parse_content(self, file: UploadFile) -> str:
        ...
        def parse_func(file_bytes: BytesIO, file_name: str):
            return partition(metadata_filename=file_name, file=file_bytes, strategy="fast")
        ...
        try:
            ...
            elements = await asyncio.wait_for(
                loop.run_in_executor(process_executor, parse_func, file_like, file.filename),
            ...
            return f"Error parsing content for {file.filename}: {str(e)}"
